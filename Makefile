...
OBJECTS_fpp_controller_so += src/controllerPlugin.o src/controller_base.o src/falconV4_controller.o src/falconV3_controller.o src/genius_controller.o src/fpp_controller.o src/wled_controller.o
